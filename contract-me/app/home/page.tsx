        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-gray-900">ContractMe</h1>
            </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {(user.role === 'USER' || user.role === 'BOTH') && (
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-medium text-blue-900 mb-2">For Customers</h4>
                ...
                {(user.role === 'CONTRACTOR' || user.role === 'BOTH') && (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-medium text-green-900 mb-2">For Contractors</h4>
